...
writeLines(as.yaml(list('filterTables' = list('Diagnosis' = list('long_title' = 'Pneumonia')),
                        ...
                        'tetrad_args' = list('algorithm' = 'grasp-fci','alpha' = 0.01,'data-type' = 'mixed', 'dataset'='Retention.txt', 'prefix'='example_output_name','delimiter' = 'tab','score' = 'cg-bic-score','test' = 'cg-lr-test'))),
           'user_input_yaml.txt')
